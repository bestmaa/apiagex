...
- T004 | Version: v0.1.0 | Status: pending | Goal: Add minimal server package with health under `/api/health`. | Verify: automated health test and manual API request. | Commit: `Add API server shell`
- T005 | Version: v0.1.1 | Status: pending | Goal: Serve `/doc`, `/readme`, `/adminui`, and `/api` from the same server. | Verify: Browser Use path check and API request. | Commit: `Add four MVP paths`
...
- T009 | Version: v0.2.0 | Status: pending | Goal: Add SQLite foundation, migrations, and tables for users, roles, schemas, fields, entries, permissions. | Verify: migration tests. | Commit: `Add MVP database foundation`
- T010 | Version: v0.2.1 | Status: pending | Goal: Add first-time owner bootstrap so first login creates or activates owner. | Verify: owner bootstrap API test and manual request. | Commit: `Add owner bootstrap`
...
- T014 | Version: v0.3.0 | Status: pending | Goal: Add schema and field repositories with relation-aware field model. | Verify: repository tests. | Commit: `Add schema repositories`
