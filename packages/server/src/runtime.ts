...
import { openMigratedSqliteAdapter, openPostgresAdapter, type ApiagexDatabase } from "@apiagex/database";
...
Environment:
  APIAGEX_DATABASE_PROVIDER sqlite or postgres. Default: sqlite.
  PORT                    Server port. Default: 4000.
  HOST                    Server host. Default: 127.0.0.1.
  APIAGEX_DATABASE_PATH   SQLite path. Default: .apiagex/apiagex.sqlite.
  APIAGEX_DATABASE_URL    PostgreSQL URL when provider is postgres.
