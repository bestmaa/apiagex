...
export function ApiList() {
  ...
  return (
    <section aria-labelledby="api-list-title">
      ...
      <p>Enable docs from <a href="#settings/api-docs">Settings / API Docs</a>, then open <a href="/swagger" target="_blank" rel="noreferrer">Swagger UI</a> or use <code>/api/openapi.json</code>.</p>
