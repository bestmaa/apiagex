  ...
  sections: [
    ...
    },
    {
      ...
      lines: [
        ...
        "Settings: /adminui#settings opens an attached submenu for Admin Roles, Content Roles, and Webhooks.",
        "Settings: /adminui#settings Admin Roles, Content Roles, aur Webhooks ke liye attached submenu kholta hai.",
        ...
        "Webhooks: /api/admin/webhooks sends signed entry notifications with delivery id, timestamp, and HMAC over timestamp.deliveryId.rawBody.",
        "Webhooks: /api/admin/webhooks delivery id, timestamp, aur timestamp.deliveryId.rawBody HMAC ke saath signed entry notifications bhejta hai.",
