  ...
  sections: [
    ...
    },
    {
      ...
      lines: [
        ...
        "Permissions: getAll, get, create, update, delete, and manage can be evaluated per API role and schema.",
        "Permissions: getAll, get, create, update, delete, aur manage API role aur schema ke hisab se evaluate hote hain.",
  ...
  sections: [
    ...
    },
    {
      ...
      lines: [
        ...
        "Role permission UI shows API roles only; owner/admin panel roles stay outside content API permissions.",
        "Role permission UI sirf API roles dikhata hai; owner/admin panel roles content API permissions se bahar rahte hain.",
