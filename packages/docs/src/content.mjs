  ...
  sections: [
    ...
    },
    {
      ...
      lines: [
        ...
        "Webhooks: /api/admin/webhooks sends signed entry notifications with delivery id, timestamp, and HMAC over timestamp.deliveryId.rawBody; Realtime API: /api/admin/realtime enables WebSocket events per schema.",
        "Webhooks: /api/admin/webhooks signed entry notifications bhejta hai; Realtime API: /api/admin/realtime per schema WebSocket events enable karta hai.",
