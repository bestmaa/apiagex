  ...
  sections: [
    ...
    },
    {
      ...
      lines: [
        ...
        "Webhooks: /api/admin/webhooks sends signed notifications; Realtime API: /api/admin/realtime enables WebSocket events and lastEventId replay per schema.",
        "Webhooks: /api/admin/webhooks signed notifications bhejta hai; Realtime API lastEventId replay ke saath per schema WebSocket events enable karta hai.",
