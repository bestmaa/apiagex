  ...
  sections: [
    ...
    },
    {
      ...
      lines: [
        ...
        "Settings API: GET /api/admin/settings/access lists admin and API role catalogs separately.",
        "Settings API: GET /api/admin/settings/access admin aur API role catalogs ko alag list karta hai.",
