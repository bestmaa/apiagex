  ...
  sections: [
    ...
    },
    {
      ...
      lines: [
        ...
        "Realtime API: /api/admin/realtime shows recent event history, keeps the latest 1000 events per schema, and supports lastEventId replay.",
        "Realtime API: /api/admin/realtime recent history dikhata hai, latest 1000 events per schema rakhta hai, aur lastEventId replay support karta hai.",
