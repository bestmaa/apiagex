  ...
  sections: [
    ...
    },
    {
      ...
      lines: [
        ...
        "Webhooks: /api/admin/webhooks manages signed entry created, updated, and deleted notifications.",
        "Webhooks: /api/admin/webhooks signed entry created, updated, aur deleted notifications manage karta hai.",
