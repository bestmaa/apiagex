  ...
  sections: [
    ...
    },
    {
      ...
      lines: [
        ...
        "Admin UI entries: collections are listed on the right, selected collection data appears in a table, and visible fields can be selected per view.",
        "Admin UI entries: collections right side me list hoti hain, selected collection data table me dikhta hai, aur visible fields per view choose ho sakte hain.",
    ...
    },
    {
      ...
      lines: [
        ...
        "Permissions: getAll, get, create, update, delete, and manage can be evaluated per role and schema.",
        "Permissions: getAll, get, create, update, delete, aur manage role aur schema ke hisab se evaluate hote hain.",
        ...
        "Manage permission: manage allows every action for that schema, including getAll, get, create, update, and delete.",
        "Manage permission: manage us schema ke sab actions allow karta hai, including getAll, get, create, update, aur delete.",
    ...
    },
    {
      heading: "QA",
      lines: [
        "Admin UI redesign: /adminui uses a custom React shell with Dashboard, Schemas, Entries, APIs, Roles, Users, and Docs navigation.",
        "Admin UI redesign: /adminui custom React shell use karta hai jisme Dashboard, Schemas, Entries, APIs, Roles, Users, aur Docs navigation hai.",
  ...
  sections: [
    ...
    },
    {
      ...
      lines: [
        ...
        "Admin Entries now shows a right-side collection rail and a table with find, visible field checkboxes, last 50 default rows, and pagination.",
        "Admin Entries ab right-side collection rail aur table dikhata hai jisme find, visible field checkboxes, last 50 default rows, aur pagination hai.",
    ...
    },
    {
      ...
      lines: [
        ...
        "Permission evaluator defaults to block, getAll allows list reads, get allows one-entry reads, manage allows all, and owner bypasses checks.",
        "Permission evaluator default block karta hai, getAll list reads allow karta hai, get one-entry reads allow karta hai, manage all allow karta hai, aur owner checks bypass karta hai.",
    ...
    },
    {
      ...
      lines: [
        ...
        "Admin UI workflows cover owner login, schema builder, entries, generated APIs, relation modeling, RBAC roles, and users.",
        "Admin UI workflows owner login, schema builder, entries, generated APIs, relation modeling, RBAC roles, aur users cover karte hain.",
        "Admin visual QA checklist is documented in docs/admin-ui-visual-qa.md.",
        "Admin visual QA checklist docs/admin-ui-visual-qa.md me documented hai.",
