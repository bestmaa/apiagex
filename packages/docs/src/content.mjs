  ...
  sections: [
    ...
    },
    {
      ...
      lines: [
        ...
        "Current status: Task3 has defined the relation contract; later Task3 tasks will add validation, storage, populate, and Admin UI editing.",
        "Current status: Task3 ne relation contract define kiya hai; later Task3 tasks validation, storage, populate, aur Admin UI editing add karenge.",
  ...
  sections: [
    ...
    },
    {
      ...
      lines: [
        ...
        "One-to-many example: Author to Articles. Many-to-many example: Articles to Tags.",
        "Current status: relation semantics are documented as Task3 contract, while runtime validation/storage will land in later Task3 tasks.",
        "Current status: relation semantics Task3 contract ke roop me documented hain, runtime validation/storage later Task3 tasks me aayega.",
